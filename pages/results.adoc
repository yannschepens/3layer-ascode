...
* Un dépôt par outil
** Le rythme des mises à jour est différent entre outils
...
[NOTE.speaker]
====
* Le maintien se fait par couche
* Il y a une indépendance de chaque layer
* Conséquence anti devops
** Seules les personnes compétentes touchent à leur couche
