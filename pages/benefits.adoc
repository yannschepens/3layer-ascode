...
* On applique, exécute le code que sur les éléments nécessaires
* L'exécution des scripts est plutôt rapide
...
* Choix des technos libres pour chaque couche
====
...
[NOTE.speaker]
====
* Les affinités professionnelles font qu'on va surtout travailler sur une couche ou deux
