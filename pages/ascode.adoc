...
[NOTE.speaker]
====
* Approche top, décorrélation "fonctionnel" et "technique"
...
* Pas nécessaire, on n'accueille pas d'autres équipes
====
...
** Régénération des services accounts
** Modification artif
** Modification de sonar

* Ex.: Déploiement d'un nouvel outil
** Ouverture de flux => Infra
** Branchement avec les outils qui s'en servent => Provisionning
...
** Idem, on risque en plus de péter un truc
...
* On sépare en couche, on trie par infra, provisionning, configuration
