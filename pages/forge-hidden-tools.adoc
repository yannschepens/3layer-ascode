...
* Sympa au début, puis problématique après
...
* Ah ...
* Cinq environnements : un dev et un prod similaires, un admin pour gérer tout ça, un de sauvegardes/backups, et un isolé pour la sortie
* Ça va être drôle à implémenter tout ça
* Ça change de nos 3 pauvres services à déployer
* On voit :
...
* Avant de passer aux couches réseau, je crois qu'on a oublié quelques éléments
====
...
[NOTE.speaker]
====
* Ça c'est globalement la vision utilisateur
* Mais en vrai, si on veut avancer dans cette conférence sans avoir affaire à un Jackson Pollock
...
[NOTE.speaker]
====
* Désolé pour l'utilisateur, mais ici, il ne me sert à rien
...
* Bon, pour le côté as code du diagramme on reviendra par contre
* Déjà, Gitlab ne vient pas tout seul
* On ajoute les runners
====

[.img-lighter, transition=none]
== !

image:forge-all-hidden-tools-6.png[6, 90%]
...
image:forge-all-hidden-tools-7.png[7, 90%]
...
image:forge-all-hidden-tools-8.png[8, 90%]
...
image:forge-all-hidden-tools-9.png[9, 90%]
...
image:forge-all-hidden-tools-10.png[10, 90%]
...
image:forge-all-hidden-tools-11.png[11, 90%]
...
image:forge-all-hidden-tools-12.png[12, 90%]

[NOTE.speaker]
====
* Un Zabbix
* Et un agrégateur de logs + monitoring supplémentaire
====

[.img-lighter, transition="none-in slide-out"]
== !

image:forge-all-hidden-tools-13.png[13, 90%]
...
====
* TOUT VA BIEN !
* Avec du docker compose et une ISO de base, ça ne devrait pas être si compliqué à mettre en place.
...
[NOTE.speaker]
====
* C'est bien d'avoir des outils, mais maintenant, il faut qu'ils communiquent, en prenant en compte les contraintes de sécu et les ouvertures de flux.
...
[NOTE.speaker]
====
* Pour éviter les ouvertures de port "technique" (ex. ssh) sur le réseau utilisateur, double adressage, donc deux cartes réseau par VM
...
[NOTE.speaker]
====
* Un pare feu L3/4 7 pour protéger tout ça
...
* En réalité, on n'a pas autant de pare-feu, mais il faudrait
====
...
[NOTE.speaker]
====
* Déjà, on voit que ça ne va pas être une mince affaire
* On ne va rien faire à la main
